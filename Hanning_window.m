function Hanning_window(signal,size,fftsize,fs)   
...
subplot(5,1,2)
plot(x)
title('windowing signal with zero padding (Hanning window)')
xlabel('sample')
ylabel('Amplitude')

subplot(5,1,3)
plot(fhz,X1)
title('mag. of windowing signal in frequency domain(Hanning window)')
xlabel('freq (Hz)')
ylabel('mag.')
